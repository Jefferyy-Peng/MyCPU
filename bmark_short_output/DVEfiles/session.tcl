...
# DVE reload session
# Saved on Thu Dec 2 23:47:26 2021
# Designs open: 1
...
gui_sg_addsignal -group "$_session_group_25" { rocketTestHarness.dut.cpu.clk rocketTestHarness.dut.cpu.reset rocketTestHarness.dut.cpu.icache_addr rocketTestHarness.dut.cpu.icache_re rocketTestHarness.dut.cpu.dcache_we rocketTestHarness.dut.cpu.dcache_re rocketTestHarness.dut.cpu.stall rocketTestHarness.dut.cpu.pc0 }

set _session_group_26 Group5
gui_sg_create "$_session_group_26"
set Group5 "$_session_group_26"

gui_sg_addsignal -group "$_session_group_26" { rocketTestHarness.dut.cpu.icache_dout rocketTestHarness.dut.cpu.inst0 rocketTestHarness.dut.cpu.dcache_addr rocketTestHarness.dut.cpu.dcache_din rocketTestHarness.dut.cpu.dcache_dout }

set _session_group_27 Group7
gui_sg_create "$_session_group_27"
set Group7 "$_session_group_27"

gui_sg_addsignal -group "$_session_group_27" { {rocketTestHarness.dut.cpu.regfile.mem[15]} {rocketTestHarness.dut.cpu.regfile.mem[14]} {rocketTestHarness.dut.cpu.regfile.mem[13]} {rocketTestHarness.dut.cpu.regfile.mem[12]} {rocketTestHarness.dut.cpu.regfile.mem[8]} {rocketTestHarness.dut.cpu.regfile.mem[2]} }

set _session_group_28 Group8
gui_sg_create "$_session_group_28"
set Group8 "$_session_group_28"

gui_sg_addsignal -group "$_session_group_28" { rocketTestHarness.dut.mem.dcache.cpu_req_valid rocketTestHarness.dut.mem.dcache.cpu_req_ready rocketTestHarness.dut.mem.dcache.cpu_req_addr rocketTestHarness.dut.mem.dcache.cpu_req_data rocketTestHarness.dut.mem.dcache.cpu_req_write rocketTestHarness.dut.mem.dcache.cpu_resp_valid rocketTestHarness.dut.mem.dcache.cpu_resp_data }
...
gui_wv_zoom_timerange -id ${Wave.1} 897410 1971069
...
gui_marker_move -id ${Wave.1} {C1} 1090000
